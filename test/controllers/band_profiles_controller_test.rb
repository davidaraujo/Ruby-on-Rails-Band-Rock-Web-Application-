...
class BandProfilesControllerTest < ActionController::TestCase
  ...
  test "should create band_profile" do
    assert_difference('BandProfile.count') do
      post :create, band_profile: { facebook: @band_profile.facebook, info: @band_profile.info, name: @band_profile.name, soundcloud: @band_profile.soundcloud, twitter: @band_profile.twitter }
    end
  ...
  test "should update band_profile" do
    patch :update, id: @band_profile, band_profile: { facebook: @band_profile.facebook, info: @band_profile.info, name: @band_profile.name, soundcloud: @band_profile.soundcloud, twitter: @band_profile.twitter }
    assert_redirected_to band_profile_path(assigns(:band_profile))
  end
